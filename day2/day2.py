input = """Game 1: 1 green, 2 blue; 13 red, 2 blue, 3 green; 4 green, 14 red
...
def subset_valid(item):
    ...
    for sub in ss_list:
        ...
        ## split substrings by comma
        ss_elements = sub.split(',')
        
        for element in ss_elements:
            for colour in colours:
                idx = element.find(colour)
                if (idx != -1):
                    value = int(element[:idx:])
    ...
    for sub in ss_list:
        ...
        for element in ss_elements:
            ...
            for colour in min_colours:
                ...
                if (idx != -1):
                    value = int(element[:idx:])
                    if (value > min_colours[colour]):
                        min_colours[colour] = value
                        print("hi")
...
for item in list:
    ...
    sum += min_colours['red'] * min_colours['green'] * min_colours['blue']
